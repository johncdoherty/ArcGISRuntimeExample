// Derived from https://alexpkent.wordpress.com/2012/10/04/wpf-radial-context-menu-pie-menu/
using System;
...
namespace ArcGISRuntimeExample.Views
{
    ...
    public class RadialPanel : Panel
    {
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            // HACK: Force OnRender to be called every time, because pipelines don't update with dynamic items - probably another way that's more efficient
            InvalidateVisual();
